...
def auto_depunctuation(raw_list):
    ...
    return new_list
raw_name = pkl_input.open_pkl("./Pkl_data/WIKI_WS_name.pkl")
raw_abstract = pkl_input.open_pkl("./Pkl_data/WIKI_WS_abstract.pkl")
raw_reference = pkl_input.open_pkl("./Pkl_data/WIKI_WS_reference.pkl")
...
freq2report(bi_over_than_one,"./ngram_data/WIKI_bi_data.txt")
tri_over = []
for (word,num) in tri_sorted:
    if num >1:
        tri_over.append((word,num))
# print(bi_over_than_one)
freq2report(tri_over,"./ngram_data/WIKI_tri_data.txt")
# print(tri_over)